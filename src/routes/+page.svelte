<script>
  ...
  const translations = {
    ru: {
      eyebrow: 'Candle Lab',
      heroTitle: 'Калькулятор воска и отдушки',
      heroLead:
        'Быстрый расчет партий свечей. Добавляйте несколько калькуляторов, чтобы сравнивать разные объемы.',
      ...
      panelNote: 'Меняйте значения под объем банки и размер партии.',
      batchLabel: 'Партия',
      cardTitle: 'Объем банки и количество свечей',
      remove: 'Удалить',
      presetsLabel: 'Пресеты баночек',
      jarVolume: 'Объем банки (мл)',
    ...
    en: {
      eyebrow: 'Candle Lab',
      heroTitle: 'Wax + Fragrance Calculator',
      heroLead:
        'Plan candle batches fast. Add multiple calculators to compare jar sizes side by side.',
